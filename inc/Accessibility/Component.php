<?php
/**
 * VRCHECKE\VRCHECKE\Accessibility\Component class
 *
 * @package vrchecke
 */

namespace VRCHECKE\VRCHECKE\Accessibility;
...
class Component implements Component_Interface {
	...
	public function action_enqueue_navigation_script() {
		...
		wp_enqueue_script(
			...
			array(),
			vrchecke()->get_asset_version( get_theme_file_path( '/assets/js/navigation.min.js' ) ),
			false
		);
		wp_script_add_data( 'vrchecke-navigation', 'async', true );
		wp_script_add_data( 'vrchecke-navigation', 'precache', true );
		wp_localize_script(
			'vrchecke-navigation',
			'vrcheckeScreenReaderText',
			array(
				'expand'   => __( 'Expand child menu', 'vrchecke' ),
				'collapse' => __( 'Collapse child menu', 'vrchecke' ),
			)
		);
	}
