<?php
/**
 * VRCHECKE\VRCHECKE\Sidebars\Component class
 *
 * @package vrchecke
 */

namespace VRCHECKE\VRCHECKE\Sidebars;
 ...
 * * `vrchecke()->is_primary_sidebar_active()`
 * * `vrchecke()->display_primary_sidebar()`
 *
...
class Component implements Component_Interface, Templating_Component_Interface {
	...
	public function action_register_sidebars() {
		register_sidebar(
			array(
				'name'          => esc_html__( 'Sidebar', 'vrchecke' ),
				'id'            => static::PRIMARY_SIDEBAR_SLUG,
				'description'   => esc_html__( 'Add widgets here.', 'vrchecke' ),
