...
class Component implements Component_Interface
{
    ...
    {
        add_submenu_page( 'vrcheck_entry', __( 'Email Templates', 'vrchecke' ), __( 'Email Templates', 'vrchecke' ), 'manage_options', 'vrcheck_email_template', 'vrchecke_email_page', 'dashicons-email-alt', 1 );
    }
