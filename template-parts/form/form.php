...
<article class="vrchecke-form"
    style='background-image:url("<?php echo $bgImg; ?>");background-color:<?php echo $bgColor; ?> ;'>
    <div id="form-header-title">
        <h2><?php _e( get_theme_mod( 'top_header_title_form', 'E-Check according to DGUV V3
            we are looking for the 3 best offers in your region for free.' ), 'vrchecke' );?></h2>
    </div>
    <form action="">
